...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/CCCCCD")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/mfmvip")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/TOKYO_TEAM")]])
